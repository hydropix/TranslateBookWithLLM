# <img src="https://github.com/hydropix/TranslateBookWithLLM/blob/main/src/web/static/TBL-Logo-alpha.png?raw=true" alt="Logo" height="40"> Translate Books with LLM
